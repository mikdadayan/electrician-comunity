...
const { GET_POSTS, POSTS_ERROR, UPDATE_LIKES, DELETE_POST, ADD_POST, GET_POST, POST_ERROR, ADD_COMMENT, COMMENT_ERROR, DELETE_COMMENT } = PostActionTypes;
...
export const AddComment = (body, postId) => async dispatch => {
	...
	try {
		const res = await axios.put(`http://localhost:5000/api/posts/comment/${postId}`, {comment: body}, config);
		dispatch({
			type: ADD_COMMENT,
